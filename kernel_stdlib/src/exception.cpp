...
// #TODO: Right now this is a holding place for symbols the linker wants defined related to exception handling.
//
// They don't really do anything, so if we actually throw exceptions, that will be a problem. But we don't yet, so it's
// ok.
//
